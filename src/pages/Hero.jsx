...
function Hero({ onGetStarted }) {
  // Randomly select a dog image on mount
  const [dogImage, setDogImage] = useState('/dog-1.png');
  
  useEffect(() => {
    const randomNum = Math.floor(Math.random() * 5) + 1;
    setDogImage(`/dog-${randomNum}.png`);
  }, []);

  return (
    <div className="min-h-screen h-screen relative overflow-hidden flex flex-col items-center justify-center px-6">
      {/* Background Dog Image - NO opacity, full vivid display */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        />
        {/* Minimal overlay only at top/bottom edges for text readability */}
      ...
      >
        ...
        >
          ...
          {/* Subline */}
          <p className="font-roboto text-lg text-white/90 mt-6 max-w-xl mx-auto">
