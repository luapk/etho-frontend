...
function Hero({ onGetStarted }) {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex flex-col items-center justify-center px-6">
      {/* Background Dog Image - Centered on mobile, left-aligned on desktop */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <img 
          ...
          loading="eager"
          fetchpriority="high"
          className="absolute w-full h-full object-cover md:object-left-top"
          style={{ 
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-blue-500/30 via-blue-500/50 to-cyan-500/60 md:from-blue-500/20 md:via-blue-500/40 md:to-cyan-500/50"></div>
      </div>
