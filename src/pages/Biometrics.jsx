...
// Pet names and breeds for randomization with image mapping
const PET_OPTIONS = [
  { name: 'Luna', breed: 'Belgian Malinois', weight: 28, age: 3, image: '/dog-1.png' },
  { name: 'Max', breed: 'German Shepherd', weight: 34, age: 5, image: '/dog-2.png' },
  { name: 'Bella', breed: 'Golden Retriever', weight: 29, age: 4, image: '/dog-3.png' },
  { name: 'Charlie', breed: 'Labrador Retriever', weight: 32, age: 2, image: '/dog-4.png' },
  { name: 'Daisy', breed: 'Beagle', weight: 11, age: 6, image: '/dog-5.png' },
  { name: 'Cooper', breed: 'Border Collie', weight: 19, age: 3, image: '/dog-1.png' },
  { name: 'Milo', breed: 'French Bulldog', weight: 12, age: 4, image: '/dog-2.png' },
  { name: 'Sadie', breed: 'Siberian Husky', weight: 23, age: 2, image: '/dog-3.png' }
];
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-full overflow-hidden bg-gradient-to-br from-cyan-400 to-blue-500 flex items-center justify-center">
                <img 
                  src={pet.image} 
                  alt={pet.name}
                  ...
                  onError={(e) => {
                    ...
                    e.target.parentElement.innerHTML = `<span class="text-white font-bold font-roboto text-lg">${pet.name.charAt(0)}</span>`;
                  }}
                />
              </div>
              <div>
